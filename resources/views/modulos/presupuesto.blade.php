                     ...
                     <div class="bar-inner">
                      <ul>
                        ...
                        <ul class="breadcrumb">
                          ...
                          <li><a href="{{ url('/presupuesto') }}" class="active">Presupuesto</a>
                          </li>
                        </ul>
                        <!-- END BREADCRUMB -->
                          <ul class="mega">
                    ...
                    <div class="col-lg-5 col-md-height col-md-6 col-top">
                      ...
                      <div class="panel panel-transparent">
                        ...
                        <div class="panel-body">
                          <h3>Presupuesto</h3>
                          <p>Asignación original de recursos publicada en el Presupuesto Aprobado de Egresos para ser aplicado en un ejercicio fiscal.</p>
                          <br>
