                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3 " >
                                  ...
                                  <ul class="sub-menu">
                                    ...
                                    <li ><a href="#">2/ Recepción e inventario</a></li>
                                    <li ><a href="#">3/ Suministro de bienes</a></li>
            ...
            <div class="container-fluid container-fixed-lg">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active">Bienes y Patrimonio</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="col-lg-5 col-md-height col-md-6 col-top">
                      ...
                      <div class="panel panel-transparent">
                        ...
                        <div class="panel-body">
                          ...
                          <p>Administración de los bienes y los servicios de apoyo administrativo necesarios para el ejercicio de las atribuciones a cargo del Organismo.</p>
                          <br>
