                ...
                <div class="invoice padding-50 sm-padding-10">
                  <div>
                    ...
                    <div class="pull-right sm-m-t-20">
                      <h2 class="font-montserrat all-caps hint-text">Reporte de Libro Diario</h2>
                    </div>
                  ...
                  <br>
                  <div>
                    <img width="1000" height="565" alt="" class="invoice-signature" data-src-retina="{{ URL::asset('assets/img/reportes/reporte_libro_diario.jpg') }}" data-src="{{ URL::asset('assets/img/reportes/reporte_libro_diario.jpg') }}" src="{{ URL::asset('assets/img/reportes/reporte_libro_diario.jpg') }}">
                  </div>
                  </div>
                  <br>
                  <br>
