                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <ul class="nav navbar-nav navbar-right">
                      <li>
                        <a href="{{ url('bienes/submodulo/almacen/reportes/entrada', $salida->id) }}" class="p-r-10"><img width="25" height="25" alt="" class="icon-pdf" data-src-retina="assets/img/invoice/pdf2x.png" data-src="{{ URL::asset('assets/img/invoice/pdf.png') }}" src="assets/img/invoice/pdf2x.png"></a>
                      </li>
                      <li>
                ...
                <div class="invoice padding-50 sm-padding-10">
                  <div>
                    ...
                    <div class="pull-right sm-m-t-20">
                      <h2 class="font-montserrat all-caps hint-text">Salida de Inventario</h2>
                    </div>
                    ...
                    <div class="row-sm-height">
                      ...
                      <div class="col-md-6 col-sm-height col-bottom sm-no-padding sm-p-b-20">
                        ...
                        <div>
                          ...
                          <div class="pull-right"><strong>{{ $salida['cve_presup'] }}</strong></div>
                          <div class="clearfix"></div>
                        </div>
                        <div>
                          <div class="pull-left font-montserrat bold all-caps">Folio Orden de Compra:</div>
                          <div class="pull-right"><strong>{{ $salida['folio_compra'] }}</strong></div>
                          <div class="clearfix"></div>
                        </div>
                        <div>
                          <div class="pull-left font-montserrat bold all-caps">Fecha de entrada:</div>
                          <div class="pull-right"><strong>{{ $salida['fecha_ent'] }}</strong></div>
                          <div class="clearfix"></div>
                        </div> 
                      </div>
                    </div>
                    ...
                    <form id="form-project" role="form" autocomplete="off">
                        ...
                        <div class="row clearfix">
                          <div class="col-sm-2">
                            <div class="form-group form-group-default">
                              ...
                              <input type="text" class="form-control" value="{{ $salida['fecha_fact'] }}" disabled>
                            </div>
                          </div>
                          <div class="col-sm-2">
                            <div class="form-group form-group-default">
                              <label>Folio de Factura</label>
                              <input type="text" class="form-control" value="{{ $salida['folio_fact'] }}" disabled>
                            </div>
                          </div>
                          ...
                          <div class="col-sm-8">
                            <div class="form-group form-group-default">
                              ...
                              <input type="text" class="form-control" value="{{ $salida['proveedor'] }}" disabled>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="form-group-attached">
                        <div class="row clearfix">
                          <div class="col-sm-3">
                            <div class="form-group form-group-default">
                              ...
                              <input type="text" class="form-control" value="{{ $salida['bien'] }}" disabled>
                            </div>
                          </div>
                          <div class="col-sm-3">
                            <div class="form-group form-group-default">
                              <label>Clave del Bien</label>
                              <input type="text" class="form-control" value="{{ $salida['cve_bien'] }}" disabled>
                            </div>
                          </div>
                          ...
                          <div class="col-sm-2">
                            <div class="form-group form-group-default">
                              <label>Marca</label>
                              <input type="text" class="form-control" value="{{ $salida['marca'] }}" disabled>
                            </div>
                          </div>
                        ...
                        <div class="col-sm-2">
                           <div class="form-group form-group-default">
                             <label>Modelo</label>
                             <input type="text" class="form-control" value="{{ $salida['modelo'] }}" disabled>
                           </div>
                         </div>
                         ...
                         <div class="col-sm-2">
                           <div class="form-group form-group-default">
                             ...
                             <input type="text" class="form-control" value="{{ $salida['cantidad'] }}">
                           </div>
                         </div>
                        </div>  
                        ...
                        <div class="row clearfix">
                          <div class="col-sm-10">
                            <div class="form-group form-group-default">
                              ...
                              <input type="text" class="form-control" value="{{ $salida['carac'] }}" disabled>
                            </div>
                          </div>
                          <div class="col-sm-2">
                            <div class="form-group form-group-default">
                              <label>Costo Unitario</label>
                              <input type="text" class="form-control" value="{{ $salida['costo_unit'] }}" disabled>
                            </div>
                          </div>
                      ...
                      <div class="row clearfix">                        
                          <div class="col-sm-3">
                            <div class="form-group form-group-default input-group">
                              ...
                              <input type="text" class="form-control" value="${{ $salida['total'] }}" disabled>
