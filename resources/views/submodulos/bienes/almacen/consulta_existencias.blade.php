            ...
            <div class="container-fluid container-fixed-lg">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active">Consultas de Existencias</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
                  ...
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="col-sm-2">
                        ...
                        <form class="m-t-10" role="form">
                        <button class="btn btn-sm  btn-rounded btn-danger" type="button"><i class="pg-form"></i> Ir a formulario</button>                      
                        </form>
                      </div>
