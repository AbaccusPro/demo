                    ...
                    <div class="col-lg-5 col-md-height col-md-6 col-top">
                      ...
                      <div class="panel panel-transparent">
                        ...
                        <div class="panel-body">
                          ...
                          <p>En esta sección podrá registrar salidas de bienes registrados en el inventario.</p>
                          <br>
                        </div>
                      </div>
                      <!-- END PANEL -->
...
<!-- CHANGE 'content' HERE-->
          ...
          <div class"row">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="panel-title">Salida de bienes
                </div>
                <div><h5>Dé click en el nombre del bien y posteriormente actualice la cantidad de bienes para dar salida.</h5>
                </div>
                <div class="pull-right">
                  <div class="col-xs-12">
                  ...
                  <thead>
                    ...
                    @foreach ($bien_sub4_1 as $bien_sub4_1)
                      <tr class="even gradeC">
                        <td><a href="{{ url('bienes/submodulo/almacen/editar_bien', $bien_sub4_1->id) }}">{{$bien_sub4_1->bien}}</td></a>
