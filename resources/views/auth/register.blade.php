...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>Abaccus Pro - El abc de armonización contable</title>
    ...
    <div class=" full-width">
      <div class="register-container m-b-10 clearfix">
        <div class="inline pull-left">
          <img src="{{ URL::asset('assets/img/abc_simbolo-login.png') }}" alt="" class="m-t-5 " width="50" height="49">
        </div>
        <div class="col-md-10 m-t-15">
          <p class="hinted-text small inline ">Todos los datos contenidos en el demo son de caracter confidencial. Todos los Derechos Reservados 2016 ®</p>
        </div>
      </div>
    </div>
    <!-- BEGIN VENDOR JS -->
