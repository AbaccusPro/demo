...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>Abaccus Pro - El abc de Contabilidad Gubernamental</title>
  ...
  <body class="fixed-header ">
    <div class="login-wrapper ">
      ...
      <div class="bg-pic">
        ...
        <img src="assets/img/login_fondo.jpg" data-src="assets/img/login_fondo.jpg" data-src-retina="assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg" alt="" class="lazy">
        <!-- END Background Pic-->
      ...
      <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          <img src="assets/img/abc_logo_login.png" height="40" width="200" alt="Abaccus Pro" data-src="assets/img/abc_logo_login.png" data-src-retina="assets/img/logo_2x.png" width="78" height="22">
          <p class="p-t-35">Acceso al sistema</p>
          <!-- START Login Form -->
            <form id="form-login" class="p-t-15" role="form" method="POST" action="{{ url('login') }}">
            {{ csrf_field() }}

                        <div class="form-group form-group-default{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="controls">Usuario</label>
          ...
          <div class="pull-bottom sm-pull-bottom">
            <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
              <div class="col-sm-3 col-md-2 no-padding">
                <img alt="" class="m-t-5" data-src="assets/img/abc_simbolo-login.png" data-src-retina="assets/img/demo/pages_icon_2x.png" height="50" width="49" src="assets/img/demo/pages_icon.png" width="60">
              </div>
