...
<div class="page-content-wrapper">
	...
	<!-- START ROW -->
           <div class="row">
                ...
                class="portlet-icon portlet-icon-refresh-lg-master"></i></a>
                        ...
                        <div class="panel-body">
                          <div class="pull-bottom bottom-left bottom-right ">
                            <span class="label font-montserrat fs-11">TESORERÍA</span>
                            <br>
                            <h2 class="text-white">Situación Financiera</h2>
                            <p class="text-white hint-text">Ir al módulo de Tesorería ></p>
                            <div class="row stock-rates m-t-15">
                              <div class="company col-xs-4">
                                <div>
                                  <p class="font-montserrat text-success no-margin fs-16">
                                    <i class="fa fa-caret-up"></i> +5.95%
                                    <span class="font-arial text-white fs-12 hint-text m-l-5">$546,405.63</span>
                                  </p>
                              ...
                              <div class="company col-xs-4">
                                <div>
                                  <p class="font-montserrat text-danger no-margin fs-16">
                                    ...
                                    <span class="font-arial text-white fs-12 hint-text m-l-5">$345,659.34</span>
                                  </p>
                                  <p class="bold text-white no-margin fs-11 font-montserrat lh-normal">
                                    EGRESOS
                                  </p>
                              ...
                              <div class="panel-heading ">
                                <div class="panel-title text-black hint-text">
                                  <span class="font-montserrat fs-11 all-caps">
                                    Flujo de Efectivo Diario <i class="fa fa-chevron-right"></i>
                                  </span>
                                </div>
                                <div class="panel-controls">
                                  <ul>
                          ...
                          <div class="row-sm-height">
                            <div class="col-sm-height col-top">
                              <div class="p-l-20 p-r-20">
                                <h5 class="no-margin p-b-5 pull-left hint-text">Contabilidad</h5>
                                <p class="pull-right no-margin bold hint-text">$252,363</p>
                          ...
                          <div class="row row-xs-height">
                            <div class="col-xs-5 col-xs-height col-middle relative">
                              <div class="padding-15 top-left bottom-left">
                                <h5 class="hint-text no-margin p-l-10">Asistencias del día</h5>
                                <p class=" bold font-montserrat p-l-10">2,345
                                  <br>Recursos Humanos</p>
                ...
                <div class="row">
                  <div class="col-sm-6 m-b-10">
                    <div class="ar-1-1">
                      ...
                      <div class="widget-2 panel no-border bg-primary widget-loader-circle-lg no-margin">
                        <div class="panel-heading">
                          <div class="panel-controls">
                            <ul>
              ...
              class="portlet-icon portlet-icon-refresh-lg-white"></i></a>
                        ...
                        <div class="panel-body">
                          <div class="pull-bottom bottom-left bottom-right padding-25">
                            <span class="label font-montserrat fs-11">AVISOS</span>
                            <br>
                            <h3 class="text-white">Cambios en la Ley General de Contabilidad</h3>
                            <p class="text-white hint-text hidden-md">Leer Artículo ></p>
                          </div>
                        </div>
                      </div>
                      <!-- END WIDGET -->
                          ...
                          <div class="metro live-tile" data-mode="carousel" data-start-now="true" data-delay="3000">
                            <div class="slide-front tiles slide active">
                              <div class="padding-30">
                                <div class="pull-top">
                                  ...
                                  <div class="pull-right">
                                    <ul class="list-inline ">
                                      <li>
                                        <a href="#" class="no-decoration"><i class="fa fa-comment"></i>
                                        </a>
                                      </li>
                                      <li>
                                ...
                                <div class="pull-bottom p-b-30">
                                  <p class="p-t-10 fs-12 p-b-5 hint-text">2 Enero</p>
                                  <h3 class="no-margin text-white p-b-10">¡Feliz Año Nuevo!
                                <br>Iniciamos el año con
                                <span class="semi-bold">el pie derecho</span>
                            </h3>
                                </div>
                              </div>
                            </div>
                            <div class="slide-back tiles">
                              <div class="padding-30">
                                ...
                                <div class="pull-bottom p-b-30">
                                  <p class="p-t-10 fs-12 p-b-5 hint-text">4 Enero</p>
                                  <h3 class="no-margin text-white p-b-10">Día de Reyes
                                <br>
                                <span class="semi-bold">Listos para partir la rosca</span>
                            </h3>
                                </div>
                              </div>
                            </div>
                  ...
                  <div class="col-sm-6 m-b-10">
                    <div class="ar-1-1">
                      ...
                      <div class="panel no-border bg-master widget widget-6 widget-loader-circle-lg no-margin">
                        ...
                        <div class="panel-body">
                          <div class="pull-bottom bottom-left bottom-right padding-25">
                            <h1 class="text-white semi-bold">25&#176;</h1>
                            <span class="label font-montserrat fs-11">XALAPA HOY</span>
                            <p class="text-white m-t-20">Soleado</p>
                            <p class="text-white hint-text m-t-30">28 de Noviembre de 2016 </p>
                          </div>
                        </div>
                      </div>
                      <!-- END WIDGET -->
                            ...
                            <div class="slide-front tiles slide active">
                              <div class="padding-30">
                                <div class="pull-bottom p-b-30 bottom-right bottom-left p-l-30 p-r-30">
                                  <h5 class="no-margin semi-bold p-b-5">Reporte de Gasto General</h5>
                                  <p class="no-margin text-black hint-text">Comportamiento diario</p>
                                  <h3 class="semi-bold text-white"><i
                  class="fa fa-sort-up small text-white"></i> 0.15 (0.13%)
              </h3>
                                  <p><span class="text-black">Contabilidad</span> <span class="m-l-20 hint-text"></span>
                                  </p>
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="container-sm-height full-height">
                                <div class="row-sm-height">
                                  <div class="col-sm-height padding-25">
                                    <p class="hint-text text-black">Comportamiento por área
                                    </p>
                                    <p class="p-t-10 text-black">Recursos Humanos</p>
                                    <div class="p-t-10">
                                    ...
                                    <p class="p-t-10 text-black">Obra Pública</p>
                                    <div class="p-t-10">
              ...
              class="portlet-icon portlet-icon-refresh"></i></a>
                    ...
                    <div class="p-l-25 p-r-25 p-b-20">
                      <div class="pull-left">
                        <h2 class="text-success no-margin">Autorizaciones Pendientes</h2>
                      </div>
        ...
        <small class="semi-bold">$</small>
            ...
            <div class="row">
                        ...
                        <div class="row-xs-height">
                          <div class="col-xs-height col-top">
                            <div class="panel-heading top-left top-right">
                              <div class="panel-title text-black hint-text">
                                <span class="font-montserrat fs-11 all-caps">Ingresos por Caja<i
                        ...
                        <div class="row-xs-height ">
                          <div class="col-xs-height col-top relative">
                            <div class="row">
                              <div class="col-sm-6">
                                <div class="p-l-20">
                                  <h3 class="no-margin p-b-5 text-white">$140,000</h3>
                                  <p class="small hint-text m-t-5">
                                    <span class="label  font-montserrat m-r-5">POR DÍA</span>
                                  </p>
                                </div>
                              </div>
                              <div class="col-sm-6">
                          ...
                          <div class="col-xs-height col-top">
                            <div class="panel-heading  top-left top-right">
                              <div class="panel-title text-black">
                                <span class="font-montserrat fs-11 all-caps">Ingreso Presupuestal<i
                                    class="fa fa-chevron-right"></i>
                                                    </span>
                              </div>
                              <div class="panel-controls">
                        ...
                        <div class="row-xs-height">
                          <div class="col-xs-height col-top">
                            <div class="p-l-20 p-t-15">
                              <h3 class="no-margin p-b-5 text-white">$241,233,000</h3>
                              <a href="#" class="btn-circle-arrow text-white"><i
                class="pg-arrow_minimize"></i>
            </a>
                              <span class="small hint-text">50% por recibir</span>
                            </div>
                          </div>
                        </div>
                        <div class="row-xs-height">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="widget-10 panel no-border bg-white no-margin widget-loader-bar">
                      <div class="panel-heading top-left top-right ">
                        <div class="panel-title text-black hint-text">
                          <span class="font-montserrat fs-11 all-caps">Situación Financiera <i class="fa fa-chevron-right"></i>
                                        </span>
                        </div>
                        <div class="panel-controls">
                          <ul>
              ...
              class="portlet-icon portlet-icon-refresh"></i></a>
                      ...
                      <div class="panel-body p-t-40">
                        <div class="row">
                          <div class="col-sm-12">
                            <h4 class="no-margin p-b-5 text-complete semi-bold">Obra Pública</h4>
                            <div class="pull-left small">
                              <span>Destinado</span>
                              <span class=" text-success font-montserrat">
                                                    <i class="fa fa-caret-up m-l-10"></i> 40%
                                                </span>
                            </div>
                            <div class="pull-left m-l-20 small">
                              <span>Gastado</span>
                              <span class=" text-danger font-montserrat">
                                                    <i class="fa fa-caret-down m-l-10"></i> 70%
                                                </span>
                            </div>
                            <div class="clearfix"></div>
                          </div>
            ...
            class="pg-arrow_minimize text-danger"></i></a>
                          <span class="hint-text small">Ir al módulo</span>
                        </div>
                      </div>
                    </div>
                    <!-- END WIDGET -->
              ...
              <span class="bold">$441,568.97</span>
              <span class="text-success fs-12"></span>
                              ...
                              <div class="full-width">
                                <ul class="list-inline">
                                  ...
                                  <li><a href="#" class="font-montserrat text-master">1A</a>
                                  </li>
                                </ul>
                              </div>
              ...
              class="portlet-icon portlet-icon-refresh"></i></a>
                  ...
                  <div class="padding-25">
                    <div class="pull-left">
                      <h2 class="text-success no-margin">Autorizaciones Pendientes</h2>
                      <p class="no-margin">Órdenes de Compra / Sub-módulo</p>
                    </div>
                    <h3 class="pull-right semi-bold"><sup>
        <small class="semi-bold">$</small>
      </sup> 102,967
                  ...
                  <div class="auto-overflow widget-11-2-table">
                    <table class="table table-condensed table-hover">
                      <tbody>
                        <tr>
                          <td class="font-montserrat all-caps fs-12 col-lg-6">Orden de Compra</td>
                          <td class="text-right hidden-lg">
                            <span class="hint-text small">dewdrops</span>
                          </td>
                          <td class="text-right b-r b-dashed b-grey col-lg-3">
                            <span class="hint-text small">#2324</span>
                          </td>
                          <td class="col-lg-3">
                            <span class="font-montserrat fs-18">$2,107</span>
                          </td>
                        </tr>
                        <tr>
                          <td class="font-montserrat all-caps fs-12 col-lg-6">Solicitud de Bienes</td>
                          <td class="text-right hidden-lg">
                            <span class="hint-text small">dewdrops</span>
                          </td>
                          <td class="text-right b-r b-dashed b-grey col-lg-3">
                          ...
                          <td class="col-lg-3">
                            <span class="font-montserrat fs-18">$7,123</span>
                          </td>
                        </tr>
                        <tr>
                          <td class="font-montserrat all-caps fs-12 col-lg-6">Orden de Compra</td>
                          ...
                          <td class="text-right b-r b-dashed b-grey col-lg-3">
                            <span class="hint-text small">#1896</span>
                          </td>
                          <td class="col-lg-3">
                            <span class="font-montserrat fs-18">$25,287</span>
                          </td>
                        </tr>
                        <tr>
                          <td class="font-montserrat all-caps fs-12 col-lg-6">Orden de Compra </td>
                          ...
                          <td class="text-right b-r b-dashed b-grey col-lg-3">
                            <span class="hint-text small">#456</span>
                          </td>
                          <td class="col-lg-3">
                            <span class="font-montserrat fs-18">$5,648</span>
                          </td>
                        </tr>
                        <tr>
                          <td class="font-montserrat all-caps fs-12 col-lg-6">Solicitud de Bienes </td>
                          ...
                          <td class="text-right b-r b-dashed b-grey col-lg-3">
                            <span class="hint-text small">#657</span>
                          </td>
                          <td class="col-lg-3">
                            <span class="font-montserrat fs-18">$1,257</span>
                          </td>
                        </tr>
                        <tr>
                          <td class="font-montserrat all-caps fs-12 col-lg-6">Orden de Compra</td>
                          ...
                          <td class="text-right b-r b-dashed b-grey col-lg-3">
                            <span class="hint-text small">#878</span>
                          </td>
                          <td class="col-lg-3">
                            <span class="font-montserrat fs-18">$6,971</span>
                          </td>
                        </tr>
                        <tr>
                          <td class="font-montserrat all-caps fs-12 col-lg-6">Solicitud de Bienes </td>
                          ...
                          <td class="text-right b-r b-dashed b-grey col-lg-3">
                            <span class="hint-text small">#126</span>
                          </td>
                          <td class="col-lg-3">
                            <span class="font-montserrat fs-18">$3,621</span>
                          </td>
                        </tr>
                        <tr>
                          <td class="font-montserrat all-caps fs-12 col-lg-6">Orden de Compra </td>
                          ...
                          <td class="col-lg-3">
                            <span class="font-montserrat fs-18">$1,654</span>
                          </td>
                        </tr>
                        <tr>
                          <td class="font-montserrat all-caps fs-12 col-lg-6">Orden de Compra</td>
                          ...
                          <td class="text-right b-r b-dashed b-grey col-lg-3">
                            <span class="hint-text small">#9878</span>
                          </td>
                          <td class="col-lg-3">
                            <span class="font-montserrat fs-18">$207</span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="padding-25">
                    <p class="small no-margin">
                      <a href="{{ url('bienes/submodulo/adquisiciones/autorizacion_orden_compra') }}"><i class="fa fs-16 fa-arrow-circle-o-down text-success m-r-10"></i></a>
                      <span class="hint-text ">Ir a la bandeja de entrada</span>
                    </p>
                  </div>
                </div>
                <!-- END WIDGET -->
        ...
        <span class="text-success">+60.223%</span>
                  ...
                  <div class="p-t-10 p-l-20 p-r-20 p-b-30">
                    <div class="row">
                      <div class="col-md-9">
                        <p class="fs-16 text-black">Cuentas de Inversión
                        </p>
                        <p class="small hint-text">Comportamiento durante el año 2016
                        <br>
                        <br>Recomendaciones por parte de Banamex para incrementar el rendimiento de la cuenta
                        </p>
                      </div>
                      <div class="col-md-3 text-right">
              ...
              <div class="col-md-4 col-lg-3 col-xlg-3 m-b-10">
                ...
                <div class="widget-16 panel no-border  no-margin widget-loader-circle">
                  <div class="panel-heading">
                    <div class="panel-title">Módulo de Ingresos
                    </div>
                    <div class="panel-controls">
                      <ul>
                        <li><a href="#" class="portlet-refresh text-black" data-toggle="refresh"><i
              class="portlet-icon portlet-icon-refresh"></i></a>
                  ...
                  <div class="widget-16-header padding-20">
                    <span class="icon-thumbnail bg-master-light pull-left text-master">$</span>
                    <div class="pull-left">
                      <p class="hint-text all-caps font-montserrat  small no-margin overflow-ellipsis ">Ingresos por caja
                      </p>
                      <h5 class="no-margin overflow-ellipsis ">Anlaísis por periodo</h5>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <div class="p-l-25 p-r-45 p-t-25 p-b-25">
                    <div class="row">
                      <div class="col-md-4 ">
                        <p class="hint-text all-caps font-montserrat small no-margin ">Diario</p>
                        <p class="all-caps font-montserrat  no-margin text-success ">$14,256</p>
                      </div>
                      <div class="col-md-4 text-center">
                        <p class="hint-text all-caps font-montserrat small no-margin ">Semanal</p>
                        <p class="all-caps font-montserrat  no-margin text-warning ">$254,361</p>
                      </div>
                      <div class="col-md-4 text-right">
                        <p class="hint-text all-caps font-montserrat small no-margin ">Mensual</p>
                        <p class="all-caps font-montserrat  no-margin text-success ">$624,321</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="b-b b-t b-grey p-l-20 p-r-20 p-b-10 p-t-10">
                    <p class="pull-left">Sem. / Cobro de Agua: $254,265 </p>
                    <div class="pull-right">
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <div class="b-b b-grey p-l-20 p-r-20 p-b-10 p-t-10">
                    <p class="pull-left">Sem. / Cobro de alcantarillado: $54,265</p>
                    <div class="pull-right">
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <div class="p-l-20 p-r-20 p-t-10 p-b-10 ">
                    <p class="pull-left no-margin hint-text">Ir al módulo de Ingresos</p>
                ...
                <div class="widget-17 panel  no-border no-margin widget-loader-circle">
                  <div class="panel-heading">
                    <div class="panel-title">
                      <i class="pg-map"></i> Xalapa, Veracruz
                      ...
                      <div class="row">
                        <div class="col-md-12 col-xlg-6">
                          <div class="row m-t-20">
                            <div class="col-md-5">
                              <h4 class="no-margin">Lunes</h4>
                              <p class="small hint-text">28 de Noviembre de 2016</p>
                            </div>
                            <div class="col-md-7">
                              <div class="pull-left">
                                <p class="small hint-text no-margin">Hoy</p>
                                <h4 class="text-danger bold no-margin">22°
                    <span class="small">/ 28C</span>
                  </h4>
                              </div>
                              <div class="pull-right">
                          ...
                          <h5>Pronóstico
              <span class="semi-bold">Soleado</span>
            </h5>
                          <p>Información de Clima</p>
                          <div class="widget-17-weather">
                            <div class="row">
                              <div class="col-xs-6 p-r-10">
                                <div class="row">
                                  <div class="col-md-12">
                                    <p class="pull-left">Viento</p>
                                    <p class="pull-right bold">11km/h</p>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-12">
                                    <p class="pull-left">Amanece</p>
                                    <p class="pull-right bold">06:20</p>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-12">
                                    <p class="pull-left">Humedad</p>
                                    <p class="pull-right bold">20%</p>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-12">
                                    <p class="pull-left">Precipitación</p>
                              ...
                              <div class="col-xs-6 p-l-10">
                                <div class="row">
                                  <div class="col-md-12">
                                    <p class="pull-left">Anochece</p>
                                    <p class="pull-right bold">19:10</p>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-12">
                                    <p class="pull-left">Visibilidad</p>
                  ...
                  <div class="container-sm-height no-overflow">
                    <div class="row row-sm-height">
                      <div class="col-sm-5 col-lg-4 col-xlg-3 col-sm-height col-top no-padding">
                        <div class="panel-heading ">
                          <div class="panel-title">Obra Pública
                          </div>
                        </div>
                        <div class="panel-body">
                          ...
                          <div class="tab-content">
                            <div class="tab-pane active" id="tab1">
                              <h3>Zona Centro</h3>
                              <p class="hint-text all-caps font-montserrat small no-margin ">En proceso</p>
                              <p class="all-caps font-montserrat  no-margin text-warning ">5</p>
                              <br>
                              <p class="hint-text all-caps font-montserrat small no-margin ">Atrasadas</p>
                              <p class="all-caps font-montserrat  no-margin text-danger ">2</p>
                              <br>
                              <p class="hint-text all-caps font-montserrat small no-margin ">Terminadas</p>
                              <p class="all-caps font-montserrat  no-margin text-success ">1</p>
                            </div>
                            <div class="tab-pane " id="tab2">
                              <h3>Zona Sur</h3>
                              <p class="hint-text all-caps font-montserrat small no-margin ">En proceso</p>
                              <p class="all-caps font-montserrat  no-margin text-warning ">1</p>
                              <br>
                              <p class="hint-text all-caps font-montserrat small no-margin ">Atrasadas</p>
                              <p class="all-caps font-montserrat  no-margin text-danger ">0</p>
                              <br>
                              <p class="hint-text all-caps font-montserrat small no-margin ">Terminadas</p>
                              <p class="all-caps font-montserrat  no-margin text-success ">6</p>
                            </div>
                            <div class="tab-pane" id="tab3">
                              ...
                              <br>
                              <p class="hint-text all-caps font-montserrat small no-margin ">Terminadas</p>
                              <p class="all-caps font-montserrat  no-margin text-success ">0</p>
                            </div>
                          </div>
                        </div>
                        <div class="bg-master-light p-l-20 p-r-20 p-t-10 p-b-10 pull-bottom full-width hidden-xs">
                          <p class="no-margin">
                            ...
                            <span class="hint-text">Ver todo el Mapa</span>
                          </p>
                        </div>
                      </div>
                  ...
                  <div class="container-xs-height full-height">
                    <div class="row-xs-height">
                      <div class="col-xs-height">
                        <div class="panel-heading">
                          <div class="panel-title">Tecnología
                          </div>
                          <div class="panel-controls">
                            <ul>
                              <li><a href="#" class="portlet-refresh text-black" data-toggle="refresh"><i
                    ...
                    <div class="row-xs-height">
                      <div class="col-xs-height">
                        <div class="p-l-20 p-r-20">
                          <p>Rendimiento del Servidor</p>
                          <div class="row">
                            <div class="col-lg-3 col-md-12">
                              <h4 class="bold no-margin">5 TB</h4>
                              <p class="small no-margin">Capacidad</p>
                            </div>
                            <div class="col-lg-3 col-md-6">
                              <h5 class=" no-margin p-t-5">1,000 GB</h5>
                              <p class="small no-margin">Usado</p>
                            </div>
                            <div class="col-lg-3 col-md-6">
                              <h5 class=" no-margin p-t-5">4 TB</h5>
                              <p class="small no-margin">Libre</p>
                            </div>
  ...
  <!-- END PAGE CONTENT / NO MOVER ESTOS 2 DIVS PORQUE SON LOS QUE ENCAJONAN EL 'contenido'-->
